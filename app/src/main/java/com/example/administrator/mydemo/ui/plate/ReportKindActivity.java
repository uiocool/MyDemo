...
public class ReportKindActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] ints = CountUtil.byKind(app.getAppAd());
        if(ints != null) {
            initKindReport(ints);
        }

        re_ki_fh = (ImageButton)findViewById(R.id.re_ki_fh);
        re_ki_fh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ReportKindActivity.this, MainActivity.class);
    ...
    private void initKindReport(int[] i){
        barChart = (BarChart) findViewById(R.id.ki_bar_chart);
        ...
        labels.add("社区服务");
        labels.add("休闲娱乐");
        dataSet = new BarDataSet(entries, "按种类统计");

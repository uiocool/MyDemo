...
public class ReportAreaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] ints = CountUtil.byArea(app.getAppAd());
        if(ints != null) {
            initAeraReport(ints);
        }

        re_ar_fh = (ImageButton)findViewById(R.id.re_ar_fh);
        re_ar_fh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ReportAreaActivity.this, MainActivity.class);
    ...
    private void initAeraReport(int[] i){
        barChart = (BarChart) findViewById(R.id.ar_bar_chart);
